package com.example.huanxinim.widget;
 ...
 */
public class PSEditText extends android.support.v7.widget.AppCompatEditText {

    private static final String TAG = PSEditText.class.getSimpleName();
    ...
    public PSEditText(Context context, AttributeSet attrs, int defStyle) {
    ...
    private void init(AttributeSet attrs) {
        if (attrs != null) {
            TypedArray attrsArray = getContext().obtainStyledAttributes(attrs, R.styleable.PSEditText);

            visibilityIndicatorShow = attrsArray.getResourceId(R.styleable.PSEditText_drawable_show, R.drawable.ic_visibility_grey_900_24dp);
            visibilityIndicatorHide = attrsArray.getResourceId(R.styleable.PSEditText_drawable_hide, R.drawable.ic_visibility_off_grey_900_24dp);
            tintColor = attrsArray.getColor(R.styleable.PSEditText_tint_color, 0);
            additionalTouchTargetSize = attrsArray.getDimensionPixelSize(R.styleable.PSEditText_additionalTouchTargetSize, DEFAULT_ADDITIONAL_TOUCH_TARGET_SIZE);
