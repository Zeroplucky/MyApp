...
public class ItemHeaderDecoration extends RecyclerView.ItemDecoration {
    ...
    private ArrayList<GangRightBean> mDatas;
    private LayoutInflater mInflater;

    public ItemHeaderDecoration(Context context, ArrayList<GangRightBean> datas) {
        this.mDatas = datas;
    ...
    public ItemHeaderDecoration setData(ArrayList<GangRightBean> mDatas) {
        this.mDatas = mDatas;
        return this;
    }
    ...
    public void onDrawOver(Canvas canvas, final RecyclerView parent, RecyclerView.State state) {
        ...
        Log.e("xxx", "onDrawOver:   pos=" + pos + "  spanSize=" + spanSize);
