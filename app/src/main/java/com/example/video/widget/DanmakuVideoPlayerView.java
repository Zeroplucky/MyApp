...
import com.example.video.adapter.DanamakuAdapter;
import com.example.video.utils.BiliDanmukuParser;
...
public class DanmakuVideoPlayerView extends StandardGSYVideoPlayer {
    ...
    public DanmakuVideoPlayerView(Context context, Boolean fullFlag) {
        super(context, fullFlag);
    }

    public DanmakuVideoPlayerView(Context context) {
        super(context);
    }

    public DanmakuVideoPlayerView(Context context, AttributeSet attrs) {
        super(context, attrs);
    }

    @Override
    public int getLayoutId() {
        return R.layout.danmaku_video_player_view;
    }
     ...
     * 开始播放弹幕
     */
    private void onPrepareDanmaku(DanmakuVideoPlayerView gsyVideoPlayer) {
    ...
    public GSYBaseVideoPlayer startWindowFullscreen(Context context, boolean actionBar, boolean statusBar) {
        ...
        if (gsyBaseVideoPlayer != null) {
            DanmakuVideoPlayerView gsyVideoPlayer = (DanmakuVideoPlayerView) gsyBaseVideoPlayer;
            //对弹幕设置偏移记录
    ...
    protected void resolveNormalVideoShow(View oldF, ViewGroup vp, GSYVideoPlayer gsyVideoPlayer) {
        ...
        if (gsyVideoPlayer != null) {
            DanmakuVideoPlayerView gsyDanmaVideoPlayer = (DanmakuVideoPlayerView) gsyVideoPlayer;
     ...
     * 释放弹幕控件
     */
    private void releaseDanmaku(DanmakuVideoPlayerView danmakuVideoPlayerView) {
        if (danmakuVideoPlayerView != null && danmakuVideoPlayerView.getDanmakuView() != null) {
            danmakuVideoPlayerView.getDanmakuView().release();
        }
    }
                ...
                public void prepared() {
                    if (getDanmakuView() != null) {
                        ...
                        if (getDanmakuStartSeekPosition() != -1) {
                            resolveDanmakuSeek(DanmakuVideoPlayerView.this, getDanmakuStartSeekPosition());
     ...
     * 弹幕偏移
     */
    private void resolveDanmakuSeek(DanmakuVideoPlayerView gsyVideoPlayer, long time) {
