...
public class LoadingView extends View {
    ...
    public LoadingView(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        mInnerTriangleColor = typedArray.getColor(R.styleable.LoadingView_innerTriangleColor, 0xffffffff);
        mIsNeedBackground = typedArray.getBoolean(R.styleable.LoadingView_isNeedBackground, true);
        mBackgroundColor = typedArray.getColor(R.styleable.LoadingView_backgroundColor, 0xffC0C0C0);
...
//        mPath.close();
        ...
        mRoundRectF.left = left - 50;
        mRoundRectF.top = top - 50;
        mRoundRectF.right = left + diameter + 50;
        mRoundRectF.bottom = top + diameter + 50;
    }
...
//            canvas.drawPath(mPath, mTrianglePaint);
        ...
        mHandler.sendEmptyMessageDelayed(mHandler.REFRESH_VIEW, 50);
    }
