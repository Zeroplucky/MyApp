package com.example.widget.headerScrollView;
...
/**
 * github https://github.com/colinNaive/RecyclerViewScrollView
 */
public class HeaderScrollView extends LinearLayout {
    ...
    public HeaderScrollView(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        topOffset = a.getDimensionPixelSize(R.styleable.HeaderScrollView_top_offset, topOffset);
        a.recycle();
